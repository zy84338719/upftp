...
func (m Model) renderConfigMenu() string {
	...
	rows = append(rows, "  "+keyStyle.Render("[3]")+" "+t(lang, "ftp_server_menu")+" "+yellowStyle.Render(renderEnabled(config.AppConfig.EnableFTP)))
	rows = append(rows, "  "+keyStyle.Render("[4]")+" "+t(lang, "mcp_server_menu")+" "+yellowStyle.Render(renderEnabled(config.AppConfig.EnableMCP)))
...
func (m Model) renderConfigFTP() string {
	...
	lines = append(lines, "  "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "password")+":"))+" "+maskPassword(config.AppConfig.Password))
	lines = append(lines, "")
...
func (m Model) renderConfigHTTP() string {
	...
	if config.AppConfig.HTTPAuth.Enabled {
		lines = append(lines, "  "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "username")+":"))+" "+config.AppConfig.HTTPAuth.Username)
		lines = append(lines, "  "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "password")+":"))+" "+maskPassword(config.AppConfig.HTTPAuth.Password))
	}
	lines = append(lines, "")
...
func (m Model) renderConfigMCPToggle() string {
	...
	var lines []string
	lines = append(lines, "  "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "mcp_server")+":"))+" "+renderEnabled(config.AppConfig.EnableMCP))
	lines = append(lines, "  "+dimStyle.Render(t(lang, "restart_required")))
	lines = append(lines, "")
...
func (m Model) renderConfigView() string {
	...
	lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "auto_select_ip")+":"))+" "+fmt.Sprintf("%v", config.AppConfig.AutoSelect))
	lines = append(lines, "")
	lines = append(lines, "  "+labelStyle.Render(t(lang, "ftp_server")+":"))
	lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "enabled")+":"))+" "+renderEnabled(config.AppConfig.EnableFTP))
	lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "username")+":"))+" "+config.AppConfig.Username)
	lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "password")+":"))+" "+maskPassword(config.AppConfig.Password))
	lines = append(lines, "")
	lines = append(lines, "  "+labelStyle.Render(t(lang, "mcp_server")+":"))
	lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "enabled")+":"))+" "+renderEnabled(config.AppConfig.EnableMCP))
	lines = append(lines, "")
	lines = append(lines, "  "+labelStyle.Render(t(lang, "http_authentication")+":"))
	lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "enabled")+":"))+" "+renderEnabled(config.AppConfig.HTTPAuth.Enabled))
	if config.AppConfig.HTTPAuth.Enabled {
		lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "username")+":"))+" "+config.AppConfig.HTTPAuth.Username)
		lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "password")+":"))+" "+maskPassword(config.AppConfig.HTTPAuth.Password))
	}
	...
	lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "enabled")+":"))+" "+renderEnabled(config.AppConfig.Upload.Enabled))
	...
	lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "level")+":"))+" "+config.AppConfig.Logging.Level)
	lines = append(lines, "    "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "format")+":"))+" "+config.AppConfig.Logging.Format)
	lines = append(lines, "")
	lines = append(lines, "  "+labelStyle.Render(fmt.Sprintf(" %-14s", t(lang, "config_file")+":"))+" "+truncateString(config.GetConfigPath(), 36))
